...
void Bass_Env_Initialize(void)
{
    ...
    {
        bass_support_env[i].batt_ntf_cfg = 0;
        bass_support_env[i].enable = false;
    }
}
                        ...
                        ke_task_id_t const src_id)
{
    ...
    bass_support_env[device_indx].batt_ntf_cfg = param->ntf_cfg;
                          ...
                          ke_task_id_t const src_id)
{
    if (param->status == GAP_ERR_NO_ERROR)
    {
        ...
        bass_support_env[device_indx].enable = true;
    }
